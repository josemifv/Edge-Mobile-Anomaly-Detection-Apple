...
Usage:
    python scripts/run_pipeline_5stages.py <input_data_dir> [--output_dir <dir>]

Example:
    python scripts/run_pipeline_5stages.py data/raw/ --output_dir results/
"""
...
def main():
    ...
    summary_file = output_path / "pipeline_summary_5stages.txt"
    with open(summary_file, 'w') as f:
        f.write("CMMSE 2025: Mobile Network Anomaly Detection Pipeline (5-Stage)\n")
        f.write("="*60 + "\n\n")
